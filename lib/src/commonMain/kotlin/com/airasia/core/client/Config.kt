...
class Config private constructor(
    ...
    class Builder(val appVersion: String) {
         ...
         * @param protocol the url protocol. if empty it will defualt to HTTPS. all caps or small does not have any effect. if pass illegal protocol the API will fail.
         * check [URLProtocol] for supported protocols and proper namings.
         * [value] a consumer host path. e.g ssor.stgairasia.com minus the http prefix and / postfix
         */
